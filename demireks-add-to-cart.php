<?php
/**
 * Plugin Name:       Demireks Add to Cart
 * Description:       A handy plugin for measure calculations.
 * Plugin URI:        https://www.yakuter.com
 * Version:           1.0.0
 * Author:            Erhan Yakut
 ...
 * @package	Theme_Customisations
 */
final class Demires_Add_to_Cart {
 ...
 * @return void
 */
function demireks_add_to_cart_main() {
	new Demires_Add_to_Cart();
}

/**
 * Initialise the plugin
 */
add_action( 'plugins_loaded', 'demireks_add_to_cart_main' );
